...
export interface TemplateValidationError {
    type: "syntax" | "missing_variable" | "invalid_helper" | "compilation" | "security";
    message: string;
    line?: number;
    column?: number;
    context?: string;
...
export interface TemplateValidationWarning {
    type: "unused_variable" | "deprecated_helper" | "performance" | "accessibility" | "security";
    message: string;
    line?: number;
    column?: number;
    context?: string;
...
export interface TemplateRenderer {
    render(template: EmailTemplate, context: TemplateContext): Promise<RenderResult>;
    renderPreview(template: EmailTemplate, sampleContext: Partial<TemplateContext>): Promise<RenderResult>;
...
export interface TemplatePostprocessor {
    process(rendered: RenderResult, context: TemplateContext): Promise<RenderResult>;
}
